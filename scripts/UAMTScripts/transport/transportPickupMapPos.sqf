...
_markerName = "Transport Pick Up";
createMarker [_markerName, _pos];
_markerName setMarkerType "hd_pickup";
_markerName setMarkerColor "ColorBlack";
_markerName setMarkerText "Transport Pick Up";

_supplyDropMessage = "You are setting the Transport Pick Up to the marked position. Do you want to proceed?";
