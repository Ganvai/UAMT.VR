...
//
// _target : Postion (ARRAY), Markername (STRING), UNIT / Target to which the paratroopers wil move
//															If _target is a unit, you can use the
//															stalk function so the paratroopers will
//															follow this unit.
//
// _stalk : BOOLEAN, Optional, default true / If this is true AND the _target is a Unit, the 
//												paratroopers will chase the unit with BIS_fnc_stalk
//
// _smoke : BOOLEAN, Option, default true / Drops four smoke grenades around the helicopter before
//											the units disembark
//
// EXAMPLES:
// ["O_Heli_Light_02_dynamicLoadout_F",["O_Soldier_F","O_Soldier_F","O_Soldier_F"],"_spawnMarker",[5736.49,6995.88,0],player,true] call UAMT_fnc_spawnParadrop;
//
...
params ["_heli","_unitsArr","_side","_spawnPos","_dropPos","_target",["_stalk",true],["_smoke",true]];

_heli = "O_Heli_Light_02_dynamicLoadout_F";
_unitsArr = ["O_Soldier_F","O_Soldier_F","O_Soldier_F"];
_side = east;
_spawnPos = "paraSpawn";
_dropPos = "paraDrop";
_target = player;
...
[_heli,_unitsArr,_side,_spawnPos,_dropPos,_target,_stalk,_smoke] spawn {
	params["_helicopter","_unitsArr","_side","_spawnPos","_dropPos","_target","_stalk","_smoke"];
