...
params ["_heli","_unitsArr","_side","_spawnPos","_dropPos","_target",["_stalk",true]];
...
[_heli,_unitsArr,_side,_spawnPos,_dropPos,_target,_stalk] spawn {
	params["_helicopter","_unitsArr","_side","_spawnPos","_dropPos","_target","_stalk"];
