...
_startPos = getMarkerPos ["insHaloCam1_1",true];
_endPos = getMarkerPos ["insHaloCam1_2",true];
...
_startPos = getMarkerPos ["insHaloCam2_1",true];
_endPos = getMarkerPos ["insHaloCam2_2",true];
...
_startPos = _target getRelPos [40, 170];
_endPos = _target getRelPos [40, 10];
_startPos set [2,((_pos select 2) * 2)];
_endPos set [2,((_pos select 2) * 2)];
