...
params ["_deliveryPos","_dir",["_side",west],["_customLoad",[]]];

// Get Config Variables
_heliClass = getMissionConfigValue "";
_pilotClass = getMissionConfigValue "";
_spawnDistance = getMissionConfigValue "";
_audio = getMissionConfigValue "";
_customAudio = getMissionConfigValue "supportControlName";
_radioName = getMissionConfigValue "";

// Set Status of sdp Function for Dialog
missionNameSpace setVariable ["supplyDropStatus",2,true];


_sdpCount = (missionNameSpace getVariable ["sdpCount",0]) + 1;
missionNameSpace setVariable ["sdpCount",_sdpCount,true];

_markerName = format ["supplyDropMarker%1",_sdpCount];
_markerText = format ["Supply Drop %1",_sdpCount];
