...
//	Outfit
//------------------------------------------------------------------
player forceAddUniform fpilot_uniform;
player addHeadgear fpilot_helmet;
player addVest fpilot_vest;
player addGoggles fpilot_facewear;
