...
//	Outfit
//------------------------------------------------------------------
player forceAddUniform crew_uniform;
player addHeadgear crew_helmet;
player addVest crew_vest;
player addGoggles crew_facewear;

if (lrAvailable && ((player getVariable "loadout") in lrRoles) && (lrRadio != "")) then {

	if (isClass(configFile >> "cfgPatches" >> "acre_main")) then {
		
		player addBackpack crew_backpack;
