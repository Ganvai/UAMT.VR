...
player addHandgunItem launcher_at_attachement1;
player addHandgunItem launcher_at_attachement2;
player addHandgunItem launcher_at_attachement3;
player addHandgunItem ((launcher_at_ammo select 0) select 0);
