...
//	Outfit
//------------------------------------------------------------------
player forceAddUniform rifleman_uniform;
player addHeadgear rifleman_helmet;
player addVest rifleman_vest;
player addGoggles facewear;
player addBackpack rifleman_backpack;
...
if (rifleman_binocs != "") then {
	player linkItem rifleman_binocs;
};
