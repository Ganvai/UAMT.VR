...
player addWeapon launcher_aa;
player addHandgunItem launcher_aa_attachement1;
player addHandgunItem launcher_aa_attachement2;
player addHandgunItem launcher_aa_attachement3;
player addHandgunItem ((launcher_aa_ammo select 0) select 0);
