...
//	Standard Outfit
//
// The standard outfit for every role except Crew and Diver roles
//------------------------------------------------------------------
uniforms = "CUP_U_CRYE_G3C_AOR1";
helmet = "CUP_H_OpsCore_Covered_MCAM_US_SF";
vests = "CUP_V_B_Armatus_BB_US_MCam";
facewear = "CUP_G_ESS_KHK_Facewrap_Tan";
...
//------------------------------------------------------------------
backpack_std = "B_AssaultPack_cbr"; // For all roles without much to carry, like Rifleman, DM, Squadleaders
backpack_med = "B_Kitbag_cbr"; // For roles with need for larger carrying capacity: MG, Medic, Groupleader, EOD, Engineer
backpack_big = "B_Carryall_cbr"; // For Roles with heavy loads, like AT,AA, all Assistants
...
std_rifle = "CUP_arifle_M4A1_SOMMOD_Grip_black";
std_scope = "CUP_optic_G33_HWS_COYOTE";
std_attachement1 = "CUP_acc_ANPEQ_15_Top_Flashlight_Tan_L";
std_attachement2 = "CUP_muzzle_snds_M16_coyote";
std_attachement3 = "";

std_rifleAmmo_inv = [
	["CUP_30Rnd_556x45_PMAG_COYOTE",5],
	["CUP_30Rnd_556x45_PMAG_COYOTE_Tracer_Red",2]
];

// Available for all Roles except fpilot
std_handgun = "CUP_hgun_Glock17_tan";
std_handgun_scope = "";
std_handgun_attachment1 = "CUP_acc_Glock17_Flashlight";
std_handgun_attachment2 = "muzzle_snds_L";
...
// Weapons
mg_rifle = "CUP_lmg_Mk48_des";
mg_scope = "CUP_optic_ACOG_Reflex_Desert";
mg_attachement1 = "muzzle_snds_H_MG";
mg_attachement2 = "CUP_acc_ANPEQ_15_Flashlight_Tan_L";
mg_attachement3 = "";
...
// Weapons
dm_rifle = "CUP_arifle_HK417_20_Desert";
dm_scope = "optic_DMS";
dm_attachement1 = "CUP_acc_ANPEQ_15_Flashlight_Tan_L";
dm_attachement2 = "muzzle_snds_B";
dm_attachement3 = "CUP_bipod_Harris_1A2_L_BLK";

dm_ammo_inv = [
	["ACE_20Rnd_762x51_M118LR_Mag",7],
...
// Inventory items
jtac_inv_u = invStd_u + san_t1_u + [["ACE_RangeTable_82mm",1], ["ACE_artilleryTable",1], ["ACE_PlottingBoard",1]];
...
gl_map = map;
gl_compass = compass;
gl_binocs = "Rangefinder";
gl_terminal = terminal_t3;
gl_radio = radio;

// Inventory items
gl_inv_u = invStd_u + san_t1_u;
...
if (launcher_at_light != "") then {
	...
	else
	{
		...
		{
			_atLightAmmoArr append (_x select 0);
		} forEach launcher_at_light_ammo;
