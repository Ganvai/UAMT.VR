...
//	Outfit
//------------------------------------------------------------------
player forceAddUniform grenadier_uniform;
player addHeadgear grenadier_helmet;
player addVest grenadier_vest;
...
if (lrAvailable && ((player getVariable "loadout") in lrRoles) && (lrRadio != "")) then {
	...
	if (isClass(configFile >> "cfgPatches" >> "acre_main")) then {
		...
		player addBackpack grenadier_backpack;
...
player linkItem grenadier_binocs;
