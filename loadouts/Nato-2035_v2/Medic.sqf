...
//	Outfit
//------------------------------------------------------------------
player forceAddUniform selectRandom medic_uniform;
player addHeadgear selectRandom medic_helmet;
player addVest selectRandom medic_vest;
...
if (lrAvailable && ((player getVariable "loadout") in lrRoles) && (lrRadio != "")) then {
	...
	if (isClass(configFile >> "cfgPatches" >> "acre_main")) then {
		...
		player addBackpack selectRandom medic_backpack;
